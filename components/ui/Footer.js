...
export default function Footer() {
  ...
  return (
    <footer 
      className="gradient-footer text-black py-12 md:py-16"
      style={{
    ...
    >
      <div className="container-custom mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="flex flex-col pt-8 md:pt-12"> {/* Shifted down */}
            <div className="mb-4">
              <img 
                src="/logo-text.png" 
                alt="Destiny Global" 
          ...
          <div className="grid grid-cols-1 gap-6"> {/* Reduced space */}
            ...
            {/* Office Address */}
            <div>
              <h3 className="heading-sm text-black mb-4 font-extrabold text-sm md:text-base">Corporate Office Address</h3>
